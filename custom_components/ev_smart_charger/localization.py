...
RUNTIME_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "live_activity.title": "EV Charging",
        "live_activity.mode.boost": "Boost",
        "live_activity.mode.night_battery": "Night · Home Battery",
        "live_activity.mode.night_grid": "Night · Grid",
        "live_activity.mode.solar_surplus": "Solar Surplus",
        "live_activity.mode.force_charge": "Force Charge",
        "live_activity.mode.charging": "Charging",
        "live_activity.status.waiting": "Waiting",
        "live_activity.status.complete": "Complete",
        "live_activity.status.idle": "Idle",
        "live_activity.target": "Target {target}",
        "live_activity.speed_unknown": "Speed n/a",
        "live_activity.target_unknown": "No target",
    ...
    "it": {
        ...
        "live_activity.title": "Ricarica EV",
        "live_activity.mode.boost": "Boost",
        "live_activity.mode.night_battery": "Notte · Batteria casa",
        "live_activity.mode.night_grid": "Notte · Rete",
        "live_activity.mode.solar_surplus": "Surplus solare",
        "live_activity.mode.force_charge": "Forza ricarica",
        "live_activity.mode.charging": "In ricarica",
        "live_activity.status.waiting": "In attesa",
        "live_activity.status.complete": "Completata",
        "live_activity.status.idle": "Inattiva",
        "live_activity.target": "Obiettivo {target}",
        "live_activity.speed_unknown": "Potenza n/d",
        "live_activity.target_unknown": "Nessun obiettivo",
    ...
    "nl": {
        ...
        "live_activity.title": "EV-laden",
        "live_activity.mode.boost": "Boost",
        "live_activity.mode.night_battery": "Nacht · Thuisbatterij",
        "live_activity.mode.night_grid": "Nacht · Net",
        "live_activity.mode.solar_surplus": "Zonne-overschot",
        "live_activity.mode.force_charge": "Laden forceren",
        "live_activity.mode.charging": "Laden",
        "live_activity.status.waiting": "Wachten",
        "live_activity.status.complete": "Voltooid",
        "live_activity.status.idle": "Inactief",
        "live_activity.target": "Doel {target}",
        "live_activity.speed_unknown": "Vermogen n.v.t.",
        "live_activity.target_unknown": "Geen doel",
